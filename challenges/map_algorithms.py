...
ALGORITHMS = [
    ...
    },
    {
        "name": "DFS",
        "function": "solve_dfs",
        "description": "Depth-First Search - may not find shortest path",
    },
    {
        "name": "A*",
        "function": "solve_astar",
        "description": "A* with Manhattan distance - optimal and efficient",
    },
    {
        "name": "Bidirectional BFS",
        "function": "solve_bidirectional_bfs",
        "description": "BFS from both ends - faster for long paths",
    },
    {
        "name": "Bidirectional A*",
        "function": "solve_bidirectional_astar",
        "description": "A* from both ends - optimal and very efficient",
    },
]
            ...
            for dr, dc in directions:
                ...
                if (
                    ...
                    if tentative_g < g_score_fwd.get((new_row, new_col), float("inf")):
                        ...
                        heapq.heappush(
                            heap_fwd, (f_score, tentative_g, new_row, new_col)
                        )
            ...
            for dr, dc in directions:
                ...
                if (
                    ...
                    if tentative_g < g_score_bwd.get((new_row, new_col), float("inf")):
                        ...
                        heapq.heappush(
                            heap_bwd, (f_score, tentative_g, new_row, new_col)
                        )
