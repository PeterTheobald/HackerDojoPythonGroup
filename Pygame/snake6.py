...
while running:
    ...
    if not game_over:
        ...
        if new_head == food_pos:
            ...
            # Prepare partial updates for food
        ...
        # Redraw the score
        # First erase the old score display area
        pygame.draw.rect(screen, BG_COLOR, score_rect)
        # Now draw the updated score
        score_rect = draw_score(score)
        ...
        # Add the tail rect if we actually popped it
