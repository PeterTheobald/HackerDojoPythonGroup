...
def load_config():
    if hasattr(load_config, 'config_path'):
...
# Why is hasattr here bad?
# Confusing! Less readable and maintainable than using a function argument
# Not thread-safe
...
def main():
    ...
    parser.add_argument('--config', type=str, default=CONFIG_FILE, help='Path to config YAML file')
